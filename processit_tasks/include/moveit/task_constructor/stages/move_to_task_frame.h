...
#include <processit_msgs/msg/WeldSeam.h>
#include <processit_msgs/srv/LoadTaskDescription.h>
...
public:
  ...
  void MoveToTaskFrame::startState(int feature_id,
                                   bool reverse_direction) void MoveToTaskFrame::setTask(int feature_id,
      ...
      moveit_msgs::Constraints setLinConstraints();

  /// get constraints for a given feature frame
  moveit_msgs::Constraints setCircConstraints(const std::string& feature_frame);
...
private:
  ...
  geometry_msgs::PoseStamped start_frame_;
  geometry_msgs::PoseStamped end_frame_;
  geometry_msgs::PoseStamped interim_frame_;
  geometry_msgs::Transform identity_transform_;
  processit_msgs::WeldSeam[] current_features_;
  ...
  void getFeatures()
      ...
      geometry_msgs::Pose[] getTaskFrames(int feature_id)
