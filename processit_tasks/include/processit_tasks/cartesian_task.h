...
namespace processit_tasks
{
    ...
    public:
        ...
        void addStage(std::string stage_caption, std::string manufacturingSubFrameID, std::string manufacturingToTaskFrameID, geometry_msgs::msg::Transform stage_offset, std::string planner_id, double velocity);
        void addStage(std::string stage_caption, geometry_msgs::msg::Pose feature_frame, std::string planner_id);
    ...
    private:
        ...
        void setPlannerProperties(std::shared_ptr<moveit::task_constructor::solvers::PipelinePlanner> pipeline_planner, std::string planner_id, double velocity);
